 ...
 */
const isLinkValidForStore = (url, storeName) => {
 ...
 */
const extractFlipkartId = (product) => {
  if (!product) return null;
 ...
 */
const generateCanonicalStoreUrl = (product, storeName) => {
 ...
 */
const getAmazonProductUrl = (product) => {
  if (!product) return 'https://www.amazon.in';
 ...
 */
const getFlipkartProductUrl = (product) => {
 ...
 */
const getStoreProductUrl = (product, store) => {
  if (!product) return 'https://www.amazon.in';
...
module.exports = {
  getAmazonProductUrl,
  getFlipkartProductUrl,
  getStoreProductUrl,
  buildExactVariantQuery,
  extractProductId,
  extractFlipkartId,
  isDirectProductUrl,
};
