        ...
        <AnimatePresence mode="popLayout">
          {!isChatStarted ? (
            ...
            >
              ...
              {/* Download Banner — links to /download.html for OS-aware handling */}
                ...
                >
                  <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
                    ...
                    <div className="text-left min-w-0">
                      ...
                      <div className="text-[9px] sm:text-[10px] text-zinc-400 truncate">Android APK • iOS Coming Soon • Live Multi-Store Pricing</div>
                    </div>
                  </div>
                  <div className="text-zinc-500 group-hover:text-white transition-colors ml-1 sm:ml-2 font-bold shrink-0">↓</div>
                </a>
              </div>
            </motion.div>
          ) : (
